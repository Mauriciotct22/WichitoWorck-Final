...
public class Vacante {
	...
	private String imagen="no-image.png"; // Por defecto se manda no-image
	...
	public String toString() {
		return "Vacante [id=" + id + ", nombre=" + nombre + ", descripcion=" + descripcion + ", direccion="+ direccion + ", fecha=" + fecha
