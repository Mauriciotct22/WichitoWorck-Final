...
public class Usuario {
	...
	// Relacion ManyToMany (Un usuario tiene muchos perfiles) ---RELACION DE UNO A MUCHOS---
	...
	public String toString() {
		return "Usuario [id=" + id + ", username=" + username + ", nombre=" + nombre + ", email=" + email + ", recidencia=" + recidencia
