package com.mm.com.controlador;
...
public class HomeController {
	...
	/**
	 * Método para realizar búsquedas desde el formulario de búsqueda de la Pagina Principal
	 */
	@GetMapping("/search")
	public String buscar(@ModelAttribute("search") Vacante vacante, Model model) {
		
		/**
		 * La busqueda de vacantes desde el formulario debera de ser únicamente en Vacantes con estado 
	...
	/**
	 * Método que muestra el formulario de login personalizado, Actualmente el que esta en uso.
	 */
	@GetMapping("/login")
